...
import ec.gob.ambiente.sigma.web.sis.beans.SeguimientoSalvaguardaBean;
import ec.gob.ambiente.sigma.web.sis.utils.Mensaje;
import ec.gob.ambiente.sigma.web.sis.utils.OperacionesCatalogo;
import ec.gob.ambiente.sigma.web.sis.utils.OperacionesListas;
import ec.gob.ambiente.sigma.web.sis.utils.ResumenPDF;
import ec.gob.ambiente.sigma.web.sis.utils.UtilsCadenas;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoAccesoRecursoEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoAreaConsolidadaEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoCatalogoEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoConformacionEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoEstadoEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoEstadoReporteEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoInstitucionEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoNivelInvolucramientoEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoParticipanteEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoRespuestaEnum;
import ec.gob.ambiente.sigma.web.sis.utils.enumeraciones.TipoResultadoAcuerdoEnum;
...
//	@EJB
//	@Getter
//	private ProjectsSafeguardFacade projectsSafeguardsFacade; 
...
//			System.out.println(getComponenteBuscarProyectos().isEsReporteSalvaguardas());
//			CODIGO_IDENTIFICACION_INDIGENA =getAplicacionBean().getCodigoIndigena();
	...
	public void vaciarValores(){
		...
		getSeguimientoSalvaguardaBean().setListaValoresRespuestasA(new ArrayList<ValueAnswers>());
		getSeguimientoSalvaguardaBean().setListaValoresRespuestasB(new ArrayList<ValueAnswers>());
		getSeguimientoSalvaguardaBean().setListaValoresRespuestasC(new ArrayList<ValueAnswers>());
		getSeguimientoSalvaguardaBean().setListaValoresRespuestasD(new ArrayList<ValueAnswers>());
		getSeguimientoSalvaguardaBean().setListaValoresRespuestasE(new ArrayList<ValueAnswers>());
		getSeguimientoSalvaguardaBean().setListaValoresRespuestasF(new ArrayList<ValueAnswers>());
		getSeguimientoSalvaguardaBean().setListaValoresRespuestasG(new ArrayList<ValueAnswers>());
	...
	public void cargarProyectos(){
		try{
			...
			getSeguimientoSalvaguardaBean().setListaProyectos(new ArrayList<Project>());
	...
	public void cargaSalvaguardasPlanAccion(){
		try{
			getSeguimientoSalvaguardaBean().setListaSalvaguardasplanAccion(new ArrayList<Safeguard>());
	 ...
	 * @return
	 */
	public Safeguard localizaSalvaguarda(int codigoSalvaguarda){
		...
		if(getSeguimientoSalvaguardaBean().getListaSalvaguardasplanAccion()!=null && getSeguimientoSalvaguardaBean().getListaSalvaguardasplanAccion().size()>0){
			for (Safeguard safeguard : getSeguimientoSalvaguardaBean().getListaSalvaguardasplanAccion()) {
	...
	public void cargaValoresRespuestaPorSalvaguarda(){
		...
		try{
			getSeguimientoSalvaguardaBean().setListaPreguntas(new ArrayList<Questions>());
			if(lista.size()>0){
				...
				for (Integer codigoSalvaguarda : lista) {
					...
					if(salvaguarda.getSafeOrder()==1 && salvaguarda.getSafeLevel()==1){
						...
						getSeguimientoSalvaguardaBean().setListaPreguntasA(new ArrayList<Questions>());
...
//							listaTempValoresRespuesta = Stream.concat(listaTempValoresRespuesta.stream(), getSeguimientoSalvaguardaBean().getListaValoresRespuestasA().stream()).collect(Collectors.toList());
						...
						getSeguimientoSalvaguardaBean().setListaPreguntasB(new ArrayList<Questions>());
...
//						listaTempValoresRespuesta = Stream.concat(listaTempValoresRespuesta.stream(), getSeguimientoSalvaguardaBean().getListaValoresRespuestasB().stream()).collect(Collectors.toList());
						...
						getSeguimientoSalvaguardaBean().setListaPreguntasC(new ArrayList<Questions>());
...
//							listaTempValoresRespuesta = Stream.concat(listaTempValoresRespuesta.stream(), getSeguimientoSalvaguardaBean().getListaValoresRespuestasC().stream()).collect(Collectors.toList());
						...
						getSeguimientoSalvaguardaBean().setListaPreguntasD(new ArrayList<Questions>());
...
//							listaTempValoresRespuesta = Stream.concat(listaTempValoresRespuesta.stream(), getSeguimientoSalvaguardaBean().getListaValoresRespuestasD().stream()).collect(Collectors.toList());
						...
						getSeguimientoSalvaguardaBean().setListaPreguntasE(new ArrayList<Questions>());
...
//							listaTempValoresRespuesta = Stream.concat(listaTempValoresRespuesta.stream(), getSeguimientoSalvaguardaBean().getListaValoresRespuestasE().stream()).collect(Collectors.toList());
						...
						getSeguimientoSalvaguardaBean().setListaPreguntasF(new ArrayList<Questions>());
...
//							listaTempValoresRespuesta = Stream.concat(listaTempValoresRespuesta.stream(), getSeguimientoSalvaguardaBean().getListaValoresRespuestasF().stream()).collect(Collectors.toList());
						...
						getSeguimientoSalvaguardaBean().setListaPreguntasG(new ArrayList<Questions>());
...
//				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasA().setTareCatPlanGobierno(buscaCatalogoPlanGobierno(getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasA().getTareColumnNumberSix()));
	...
	public void grabarSalvaguardaA(){
		try{
			...
			getSeguimientoSalvaguardaBean().getAdvanceExecutionSafeguards().setTableResponsesList(new ArrayList<TableResponses>());
	...
	public void controlaCambiosFechaPeriodoReportar(){
		...
		desde = String.valueOf(getSeguimientoSalvaguardaBean().getAnioReporte()).concat("-").concat(getComponenteBuscarProyectos().getBuscaProyectosBean().getMesDesde());
		hasta = String.valueOf(getSeguimientoSalvaguardaBean().getAnioReporte()).concat("-").concat(getComponenteBuscarProyectos().getBuscaProyectosBean().getMesHasta());
	...
	public void preparaInformacionSalvaguardaA(){
		...
		getSeguimientoSalvaguardaBean().setCatalogoPoliticasSeleccionado(new ArrayList<Integer>());
		getSeguimientoSalvaguardaBean().setCatalogoLeyesSeleccionado(new ArrayList<Integer>());
		getSeguimientoSalvaguardaBean().setCatalogoMarcoJuridicoNacionalSeleccionado(new ArrayList<Integer>());
		getSeguimientoSalvaguardaBean().setCatalogoNormativaSecundariaNacionalSeleccionado(new ArrayList<Integer>());
		getSeguimientoSalvaguardaBean().setTablaSalvaguardaA(new ArrayList<TableResponses>());
		getSeguimientoSalvaguardaBean().setTablaSalvaguardaOPA(new ArrayList<TableResponses>());
		try{
	...
	public void cargaCatalogoPlanGobierno(){
		try{
			getSeguimientoSalvaguardaBean().setCatalogoPlanGobierno(new ArrayList<Catalogs>());
	...
	public void cargaCatalogoModalidad(){
		try{
			getSeguimientoSalvaguardaBean().setListaCatalogoModalidad(new ArrayList<Catalogs>());
			...
			getSeguimientoSalvaguardaBean().setListadoModalidades(new ArrayList<String>());
	...
	public void cargaCatalogoActividad(){
		try{
			getSeguimientoSalvaguardaBean().setListaCatalogoActividad(new ArrayList<Catalogs>());
			...
			getSeguimientoSalvaguardaBean().setListadoActividades(new ArrayList<String>());
	...
	public void cargaCatalogoEstado(){
		try{
			getSeguimientoSalvaguardaBean().setListaCatalogoEstado(new ArrayList<Catalogs>());
			...
			getSeguimientoSalvaguardaBean().setListadoEstados(new ArrayList<String>());
	...
	public void cargaCatalogoConformacion(){
		try{
			getSeguimientoSalvaguardaBean().setListaCatalogoConformacion(new ArrayList<Catalogs>());
			...
			getSeguimientoSalvaguardaBean().setListadoConformacion(new ArrayList<String>());
	...
	public void cargaCatalogoMonitoreoRemoto(){
		try{
			getSeguimientoSalvaguardaBean().setListadoMonitoreoRemoto(new ArrayList<String>());
	...
	public void cargaCatalogoInstitucionAcompania(){		
		try{
			getSeguimientoSalvaguardaBean().setListadoinstitucionAcompania(new ArrayList<String>());
	...
	public void cargaCatalogoMonitoreoinSitu(){
		try{
			getSeguimientoSalvaguardaBean().setListadoMonitoreoInSitu(new ArrayList<String>());
	...
	public void cargaCatalogoPeriodicidad(){
		try{
			getSeguimientoSalvaguardaBean().setListadoPeriodicidad(new ArrayList<String>());
	...
	public void cargarCatalogoServicio(){
		try{
			getSeguimientoSalvaguardaBean().setListaServicio(new ArrayList<Catalogs>());
	...
	public void cargaCatalogoTipoDeAcceso(){
		try{
			getSeguimientoSalvaguardaBean().setListaCatalogoTipoAcceso(new ArrayList<Catalogs>());
	...
	public void cargaListadoTipoInvolucramiento(){
		getSeguimientoSalvaguardaBean().setListadoNivelInvolucramiento(new ArrayList<String>());
	...
	public void cargaSociosImplementadores(){
		try{
			getSeguimientoSalvaguardaBean().setListaSociosImplementadores(new ArrayList<Partner>());
	...
	public void cargaCatalogoAccionImplementada(){
		try{
			getSeguimientoSalvaguardaBean().setListaCatalogoAccionImplementada(new ArrayList<Catalogs>());
	...
	public void eliminaRegistroTabla(int tablaRespuesta){
		try{
			...
			case 3:
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB51Aux(new ArrayList<TableResponses>());
				break;
			case 4:
			...
			case 5:
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB81Aux(new ArrayList<TableResponses>());
				break;
			case 6:
	...
	public void cargarProvincias(){
		try{
			...
			getSeguimientoSalvaguardaBean().setListaProvincias(new ArrayList<GeographicalLocations>());
	...
	public void preparaDatosB81(List<TableResponses> lista){
		getSeguimientoSalvaguardaBean().setTablaSalvaguardaB81(new ArrayList<TableResponses>());
		int provincia=0;
		int canton=0;
		int parroquia=0;
		if(lista.size()>0){
	...
	public void agregarFilasTablaSalvaguardaB143(){
		try{
				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasB143().setTareColumnTwo(UtilsCadenas.pasarArrayAString(getSeguimientoSalvaguardaBean().getInformaComunicaSeleccionadas()));
				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasB143().setTareColumnTree(UtilsCadenas.pasarArrayAString(getSeguimientoSalvaguardaBean().getInformaEjecucionSeleccionadas()));
	...
	public void inicializaNuevoRegistroTablas(){
		...
		vaciarDatosProvinciaCantonParroquia();
		getSeguimientoSalvaguardaBean().setListaCantones(new ArrayList<GeographicalLocations>());
		getSeguimientoSalvaguardaBean().setListaParroquias(new ArrayList<GeographicalLocations>());
	}
	...
	public void agregarFilasTablaSalvaguardaOPA(){
		try{
				if(getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasOPA().getTareId()==null){
					...
					getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasOPA().setQuestions(getSeguimientoSalvaguardaBean().getListaPreguntasA().get(3));	
	...
	public void agregarFilasTablaSalvaguardaOPB(){
		try{
				if(getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasOPB().getTareId()==null){
					...
					getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasOPB().setQuestions(getSeguimientoSalvaguardaBean().getListaPreguntasB().get(21));	
	...
	public void nuevaFilaTablaSalvaguardaB121(){
		...
		getSeguimientoSalvaguardaBean().setCodigoAccionImplementada(null);
	}
	...
	public void nuevaFilaTablaSalvaguardaG471(){
		...
		getSeguimientoSalvaguardaBean().setCodigoControlVigilancia(null);
	}
	...
	public void agregarFilasTablaSalvaguardaD331(){
		try{
				...
				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasD331().setTareColumnTree(UtilsCadenas.pasarArrayAString(getSeguimientoSalvaguardaBean().getNivelInvolucramientoSeleccionados()));
	...
	public void agregarFilasTablaSalvaguardaF411(){
		try{
				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasF411().setTareComponente(ubicaComponente(getSeguimientoSalvaguardaBean().getCodigoComponente()));
	...
	public void agregarFilasTablaSalvaguardaG481(){
		try{
				...
				if(getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasG481().getTareId()==null){					
					...
					getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasG481().setTareColumnTwo(UtilsCadenas.pasarArrayAString(getSeguimientoSalvaguardaBean().getInstitucionAcompaniaSeleccionados()));
	...
	public void agregarFilasTablaSalvaguardaG512(){
		try{
				...
				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasG512().setTareColumnTwo(UtilsCadenas.pasarArrayAString(getSeguimientoSalvaguardaBean().getMonitoreoRemotoSeleccionados()));
				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasG512().setTareColumnTree(UtilsCadenas.pasarArrayAString(getSeguimientoSalvaguardaBean().getMonitoreoInSituSeleccionados()));
				getSeguimientoSalvaguardaBean().getRegistroTablaRespuestasG512().setTareColumnFour(UtilsCadenas.pasarArrayAString(getSeguimientoSalvaguardaBean().getPeriodicidadSeleccionados()));
...
//					}
	...
	public void cargaTodosLosCantones(){
		try{
			...
			getSeguimientoSalvaguardaBean().setListaTodosCantones(new ArrayList<GeographicalLocations>());			
				...
				if(salvaguarda.getSafeOrder()==1 && salvaguarda.getSafeLevel()==1){
					...
					if(getSeguimientoSalvaguardaBean().getAdvanceExecutionSafeguards()!=null && getSeguimientoSalvaguardaBean().getAdvanceExecutionSafeguards().getAdexId()!=null){
						...
						if(getSeguimientoSalvaguardaBean().getListaValoresRespuestasG()==null || getSeguimientoSalvaguardaBean().getListaValoresRespuestasG().isEmpty()){
							...
							List<Questions> listaTemp= new ArrayList<Questions>();
							for (Questions q : getSeguimientoSalvaguardaBean().getListaPreguntasG()) {
								if(q.getCatalogs().getCataId()==1 ||q.getCatalogs().getCataId()==2 || q.getCatalogs().getCataId()==3){
									listaTemp.add(q);
								}
							}
//							agregaNuevosValoresRespuestas(getSeguimientoSalvaguardaBean().getListaPreguntasG().stream().filter((p)->p.getCatalogs().getCataId()==1 || p.getCatalogs().getCataId()==2 || p.getCatalogs().getCataId()==3).collect(Collectors.toList()),getSeguimientoSalvaguardaBean().getListaValoresRespuestasG());
							agregaNuevosValoresRespuestas(listaTemp,getSeguimientoSalvaguardaBean().getListaValoresRespuestasG());
						}
					}else{						
						if(getSeguimientoSalvaguardaBean().getListaValoresRespuestasG()==null || getSeguimientoSalvaguardaBean().getListaValoresRespuestasG().isEmpty()){
							valoresRespuestasPorDefecto(getSeguimientoSalvaguardaBean().getListaPreguntasG(), getSeguimientoSalvaguardaBean().getListaValoresRespuestasG());
...
//			respuesta = catalogo.getGeloName();
			for (GeographicalLocations gl : getSeguimientoSalvaguardaBean().getListaTodosCantones()) {
				if(gl.getGeloId().equals(codigo))
					respuesta = gl.getGeloName();
			}
...
//		return catalogo.getCataText2();
		for (Catalogs cata : getSeguimientoSalvaguardaBean().getCatalogoPlanGobierno()) {
			if(cata.getCataId().equals(codigo))
				respuesta = cata.getCataText2();
		}
		return respuesta;
	}
	/**
...
//		return catalogo.getCataText2();
		for (Catalogs cata : getSeguimientoSalvaguardaBean().getListaCatalogoMedidaTomada()) {
			if(cata.getCataId().equals(codigo))
				respuesta = cata.getCataText2();
		}
		return respuesta;
...
//		List<Object[]> listaTemporal = getAplicacionController().getAplicacionBean().getListaTodosCantones().stream().filter(canton->Integer.valueOf(canton[3].toString()).equals(getSeguimientoSalvaguardaBean().getCodProvincia())).collect(Collectors.toList());		
		...
		for (Object[] obj : getAplicacionController().getAplicacionBean().getListaTodosCantones()) {			
			if(Integer.parseInt(obj[3].toString()) == getSeguimientoSalvaguardaBean().getCodProvincia())
...
//		List<Object[]> listaTemporal = getAplicacionController().getAplicacionBean().getListaTodasParroquias().stream().filter(canton->Integer.valueOf(canton[3].toString()).equals(getSeguimientoSalvaguardaBean().getCodCanton())).collect(Collectors.toList());		
		List<Object[]> listaTemporal = new ArrayList<>();
		for (Object[] obj : getAplicacionController().getAplicacionBean().getListaTodasParroquias()) {
			if(Integer.parseInt( obj[3].toString()) == getSeguimientoSalvaguardaBean().getCodCanton())
				listaTemporal.add(obj);
		}
		for (Object[] objects : listaTemporal) {
			GeographicalLocations geo=new GeographicalLocations();
...
//				catalogo = getSeguimientoSalvaguardaBean().getListaProvincias().stream().filter(prov->prov.getGeloId().equals(codigo)).findFirst().get();
				for (GeographicalLocations gl : getSeguimientoSalvaguardaBean().getListaProvincias()) {
					if(gl.getGeloId().equals(codigo)){
						catalogo = gl;
						break;
					}
...
//				catalogo = getSeguimientoSalvaguardaBean().getListaCantones().stream().filter(can->can.getGeloId().equals(codigo)).findFirst().get();
				for (GeographicalLocations gl : getSeguimientoSalvaguardaBean().getListaCantones()) {
					if(gl.getGeloId().equals(codigo)){
						catalogo = gl;
						break;
					}
...
//				catalogo = getSeguimientoSalvaguardaBean().getListaParroquias().stream().filter(parr->parr.getGeloId().equals(codigo)).findFirst().get();
				for (GeographicalLocations gl : getSeguimientoSalvaguardaBean().getListaParroquias()) {
					if(gl.getGeloId().equals(codigo)){
						catalogo = gl;
						break;
					}
	...
	public void eliminaValoresTablaDatos(){
		try{
			if(getSeguimientoSalvaguardaBean().getCodigoTablaDatos().equals("B41")){
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB41(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB51(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB61(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB62(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB71(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB9(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB102(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB121(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB131(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaB143(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC201(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC211(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC241(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC242(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC26(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC271(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC291(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC301(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaC311(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaD321(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaD331(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE341(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE351(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE361(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE371(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE381(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE391(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_1(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_2(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_3(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_4(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_5(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_6(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_7(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_8(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_9(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_10(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_11(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_12(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_13(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_14(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_15(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_16(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_17(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_18(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_19(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_20(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_21(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_22(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_23(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_24(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_25(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_26(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_27(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_28(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_29(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_30(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_31(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_32(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_33(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_34(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_35(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_36(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_37(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaE40_38(new ArrayList<TableResponses>());
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaF411(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaF421(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaF431(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaF441(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaF452(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaG461(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaG471(new ArrayList<TableResponses>());
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaG481(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaG491(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaG501(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
				...
				getSeguimientoSalvaguardaBean().setTablaSalvaguardaG512(new ArrayList<TableResponses>());				
				getSeguimientoSalvaguardaBean().setCodigoTablaDatos("");				
...
//		}
		...
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaPueblosNacionalidades()) {
			if(ca.getCataId().equals(codigoPueblo)){
				pueblo=ca.getCataText1();
				break;
			}
		}
...
//		}
		for (Catalogs ca : getSeguimientoSalvaguardaBean().getListaHerramientas()) {
			if(ca.getCataId().equals(codigoHerramienta)){
				herramienta=ca.getCataText2();
				break;
			}
		}
...
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaAutoIdentificacion()) {
			if(ca.getCataId().equals(codigo)){
				identificacion=ca.getCataText1();
				break;
			}
		}
...
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaAlternativaEconomica()) {
			if(ca.getCataId().equals(codigo)){
				alternativa=ca.getCataText1();
				break;
			}
		}
		return alternativa;
...
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaMetodo()) {
			if(ca.getCataId().equals(codigo)){
				metodo=ca.getCataText1();
				break;
			}
		}
		return metodo;
...
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaPublico()) {
			if(ca.getCataId().equals(codigo)){
				publico=ca.getCataText1();
				break;
			}
		}
		return publico;
...
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaRecursos()) {
			if(ca.getCataId().equals(codigo)){
				recurso=ca.getCataText1();
				break;
			}
		}
		return recurso;
...
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaPeriodicidad()) {
			if(ca.getCataId().equals(codigo)){
				periodicidad=ca.getCataText1();
				break;
			}
		}
		return periodicidad;
...
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaSistemas()) {
			if(ca.getCataId().equals(codigo)){
				sistema=ca.getCataText1();
				break;
			}
		}
		return sistema;
...
//			sistema = catalogo.getCataText1();
//		}
		for (Catalogs ca : getAplicacionController().getAplicacionBean().getListaAccion()) {
			if(ca.getCataId().equals(codigo)){
				sistema=ca.getCataText1();
				break;
			}
...
//		List<Object[]> listaTemporal = getAplicacionController().getAplicacionBean().getListaSalvaguardas().stream().filter(nivel->Integer.valueOf(nivel[2].toString()).equals(codigo)).collect(Collectors.toList());		
		List<Object[]> listaTemporal = new ArrayList<>();
		for (Object[] obj : getAplicacionController().getAplicacionBean().getListaSalvaguardas()) {
			if(Integer.valueOf(obj[2].toString()).equals(codigo))
				listaTemporal.add(obj);
		}
		for (Object[] objects : listaTemporal) {
	...
	public void cargaListadoInformaComunica(){
		try{
			getSeguimientoSalvaguardaBean().setListadoInformaComunica(new ArrayList<String>());
	...
	public void cargaListadoInformaEjecucion(){
		try{
			getSeguimientoSalvaguardaBean().setListadoInformaEjecucion(new ArrayList<String>());
	...
	public void vaciaDatosBusqueda(){
		...
		getSeguimientoSalvaguardaBean().setTabActual(0);
		vaciarValores();
		getSeguimientoSalvaguardaBean().setListaPreguntasRespuestas(new ArrayList<Questions>());

		getSeguimientoSalvaguardaBean().setAdvanceExecutionSafeguards(new AdvanceExecutionSafeguards());
		getSeguimientoSalvaguardaBean().setProyectoSeleccionado(new Project());
		getSeguimientoSalvaguardaBean().setSocioImplementador(new Partner());
...
//					Mensaje.verDialogo("dlgFinalizarReporteSalvaguarda");
	...
	public void validaFinalizarReporte(){
		try{
			if(getSeguimientoSalvaguardaBean().getAdvanceExecutionSafeguards().getProjectsStrategicPartners() == null){
				getSeguimientoSalvaguardaBean().setListaPresentadosIniciados(new ArrayList<AdvanceExecutionSafeguards>());
	...
	public void volverBuscarProyectos(){
		...
		getComponenteBuscarProyectos().buscarProyectos();
	...
	public List<AdvanceSummary> validaSalvaguardasAsignadas(AdvanceExecutionSafeguards adex,List<AdvanceSummary> listaAvance){
		...
		try{			
			...
			List<Safeguard> listaSalvaguardas= new ArrayList<>();
			if(adex.getProjectsStrategicPartners()!=null)
				listaSalvaguardasAsignadas = getProjectQuestionsFacade().listaPreguntasPartnerSeleccionadas(adex.getProjectsStrategicPartners().getPspaId(),getBuscaProyectosBean().getAnioReporte());
			else
				listaSalvaguardasAsignadas = getProjectQuestionsFacade().listaPreguntasProyectoSeleccionadas(adex.getProjects().getProjId(),getBuscaProyectosBean().getAnioReporte());
			...
			for (Safeguard sa : listaSalvaguardas) {
				boolean encontrado=false;
...
//		boolean existenSalvaguardasAsignadas = false;
		...
		try{
			...
			getSeguimientoSalvaguardaBean().setListaAvanceResumen(new ArrayList<AdvanceSummary>());
			...
			if(validaPeriodoReporteProyecto(getSeguimientoSalvaguardaBean().getProyectoSeleccionado(), getComponenteBuscarProyectos().getBuscaProyectosBean().getAnioReporte())){
				...
				getSeguimientoSalvaguardaBean().setListaComponentes(new ArrayList<Component>());
...
//					AdvanceExecutionSafeguards avance =getAdvanceExecutionSafeguardsFacade().buscarAvanceSalvaguardaGeneroReportado(getSeguimientoSalvaguardaBean().getProyectoSeleccionado().getProjId(), getSeguimientoSalvaguardaBean().getCodigoStrategicPartner()==null?0:getSeguimientoSalvaguardaBean().getCodigoStrategicPartner(), 1, String.valueOf(getComponenteBuscarProyectos().getBuscaProyectosBean().getAnioReporte()).concat("-").concat(getComponenteBuscarProyectos().getBuscaProyectosBean().getPeriodoDesde()), String.valueOf(getComponenteBuscarProyectos().getBuscaProyectosBean().getAnioReporte()).concat("-12"));
					AdvanceExecutionSafeguards avance =getAdvanceExecutionSafeguardsFacade().buscarAvanceSalvaguardaGeneroReportado(getSeguimientoSalvaguardaBean().getProyectoSeleccionado().getProjId(), getSeguimientoSalvaguardaBean().getCodigoStrategicPartner()==null?0:getSeguimientoSalvaguardaBean().getCodigoStrategicPartner(), 1, String.valueOf(getComponenteBuscarProyectos().getBuscaProyectosBean().getAnioReporte()).concat("-").concat(getComponenteBuscarProyectos().getBuscaProyectosBean().getMesDesde()), String.valueOf(getComponenteBuscarProyectos().getBuscaProyectosBean().getAnioReporte()).concat("-").concat(getComponenteBuscarProyectos().getBuscaProyectosBean().getMesHasta()));
					if(avance == null && getComponenteBuscarProyectos().getBuscaProyectosBean().getListaSectoresSeleccionados().size()>0){
						if(getLoginBean().getTipoRol()==3){
							for (ProjectsStrategicPartner psp : getLoginBean().getListaProyectosDelSocioEstrategico()) {
								if(psp.getProjId().getProjId()== getSeguimientoSalvaguardaBean().getProyectoSeleccionado().getProjId()){
									...
									if(cargarSalvaguardas()){
										...
										getSeguimientoSalvaguardaBean().setAnioReporte(getComponenteBuscarProyectos().getBuscaProyectosBean().getAnioReporte());
										getSeguimientoSalvaguardaBean().setPeriodoDesde(getComponenteBuscarProyectos().getBuscaProyectosBean().getPeriodoDesde());
										getSeguimientoSalvaguardaBean().getAdvanceExecutionSafeguards().setAdexTermFrom(String.valueOf(getSeguimientoSalvaguardaBean().getAnioReporte()).concat("-").concat(getComponenteBuscarProyectos().getBuscaProyectosBean().getMesDesde()));
										getSeguimientoSalvaguardaBean().getAdvanceExecutionSafeguards().setAdexTermTo(String.valueOf(getSeguimientoSalvaguardaBean().getAnioReporte()).concat("-").concat(getComponenteBuscarProyectos().getBuscaProyectosBean().getMesHasta()));
										...
										getComponenteBuscarProyectos().getBuscaProyectosBean().setDeshabilitaIniciarReporte(false);
										break;
									}
								}
							}
...
//				getComponenteBuscarProyectos().getBuscaProyectosBean().setDeshabilitaIniciarReporte(true);
	...
	public void obtenerSalvaguardasAsignadas(int codigoPartner,int codigoProyecto){
		...
		try{
			...
			getSeguimientoSalvaguardaBean().setListaSalvaguardasAsignadas(new ArrayList<ProjectQuestions>());
			if(codigoProyecto==0)
	...
	public void organizaSectoresSeleccionados(){
		getSeguimientoSalvaguardaBean().setListaSectoresSeleccionados(getComponenteBuscarProyectos().getBuscaProyectosBean().getListaSectoresSeleccionados());
		getSeguimientoSalvaguardaBean().getAdvanceExecutionSafeguards().setAdvanceSectorsList(new ArrayList<AdvanceSectors>());
		int codigoSector=0;
	...
	public String ubicaComponente(int codigoComponente){
		String respuesta="";
		for(Component com:getSeguimientoSalvaguardaBean().getListaComponentes()){
