...
public class GeneraBDSalvaguardaB {
	...
	public static void generaArchivoSalvaguardaB(TableResponsesFacade servicio, QuestionsFacade servicioPreguntas, List<Catalogs> listaCatalogos,List<Object[]> listaProvincias,List<Object[]> listaCanton,List<Object[]> listaParroquia,List<Component> listaComponentes){
		try{
			ResourceBundle rb;
