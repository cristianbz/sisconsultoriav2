...
import ec.gob.ambiente.sigma.ejb.sis.facades.DocumentslogFacade;
import ec.gob.ambiente.sigma.web.sis.beans.BitacoradocumentosBean;
...
public class BitacoradocumentosController implements Serializable{
	...
	public void init(){
		try{
			getBitacora().setListadoPDIProgramas(new ArrayList<String>());
			getBitacora().setListaBitacoras(new ArrayList<Documentslog>());
			getBitacora().setListaProyectos(new ArrayList<Project>());
	...
	public void nuevoRegistro(){
		getBitacora().setBitacoraDocumentos(new Documentslog());	
		getBitacora().setListadoPDIProgramasSeleccionados(new ArrayList<String>());
