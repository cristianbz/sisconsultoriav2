...
//	private List<Catalogs> listaRecursos;
	...
	@Getter
	@Setter
	private List<Safeguard> listaSalvaguardasplanAccion;
	
//	@Getter
//	@Setter
//	private List<ProjectSafeguards> listaSalvaguardasProyecto;
...
//	private boolean nuevaComunicacion;
	...
	public void init(){
		...
		setMensajeRequeridosTablasB(new ArrayList<Boolean>());
		setMensajeRequeridosTablasC(new ArrayList<Boolean>());
		setMensajeRequeridosTablasD(new ArrayList<Boolean>());
		setMensajeRequeridosTablasE(new ArrayList<Boolean>());
		setMensajeRequeridosTablasF(new ArrayList<Boolean>());
		setMensajeRequeridosTablasG(new ArrayList<Boolean>());
		for(int i=0;i<11;i++){
