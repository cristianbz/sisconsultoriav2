...
public class ProjectsGenderInfoFacade extends AbstractFacade<ProjectsGenderInfo, Integer>{
	...
	public List<ProjectsGenderInfo> listaLineasGeneroProyectoPartner(Integer codigoProyecto,Integer codigoPartner) throws Exception{
		...
		if(codigoProyecto>0 && codigoPartner>0){
			sql="SELECT PGI from ProjectsGenderInfo PGI WHERE PGI.pginStatus=TRUE AND PGI.projects.projId=:codigoProyecto AND PGI.projectsStrategicPartners.pspaId=:codigoPartner ORDER BY PGI.cataId.cataNumber";
			camposCondicion.put("codigoProyecto", codigoProyecto);		
			camposCondicion.put("codigoPartner", codigoPartner);
		}else{
			sql="SELECT PGI from ProjectsGenderInfo PGI WHERE PGI.pginStatus=TRUE AND PGI.projects.projId=:codigoProyecto AND PGI.projectsStrategicPartners.pspaId IS NULL ORDER BY PGI.cataId.cataNumber";
			camposCondicion.put("codigoProyecto", codigoProyecto);		
		}		
		listaTemp = findByCreateQuery(sql, camposCondicion);
		for (ProjectsGenderInfo pgi : listaTemp) {
...
//		return findByCreateQuery(sql, camposCondicion);
	...
	public List<ProjectsGenderInfo> listaOtrasLineasGeneroProyectoPartner(Integer codigoProyecto,Integer codigoPartner) throws Exception{
		...
		Map<String, Object> camposCondicion=new HashMap<String, Object>();
		if(codigoProyecto>0 && codigoPartner>0){
			sql="SELECT PGI from ProjectsGenderInfo PGI WHERE PGI.pginStatus=TRUE AND PGI.projects.projId=:codigoProyecto AND PGI.projectsStrategicPartners.pspaId=:codigoPartner AND PGI.cataId IS NULL ORDER BY PGI.pginId";
			camposCondicion.put("codigoProyecto", codigoProyecto);		
			camposCondicion.put("codigoPartner", codigoPartner);
		}else{
			sql="SELECT PGI from ProjectsGenderInfo PGI WHERE PGI.pginStatus=TRUE AND PGI.projects.projId=:codigoProyecto AND PGI.projectsStrategicPartners.pspaId IS NULL AND PGI.cataId IS NULL ORDER BY PGI.pginId";
			camposCondicion.put("codigoProyecto", codigoProyecto);		
		}			
		return findByCreateQuery(sql, camposCondicion);
	}
	...
	public Integer numeroLineasAccionProyectoSeleccionado(Integer codigoProyecto)throws Exception{
		String sql="SELECT COUNT(PGI) FROM ProjectsGenderInfo PGI WHERE PGI.projects.projId=:codigoProyecto AND PGI.pginStatus=TRUE";
		Map<String, Object> camposCondicion=new HashMap<String, Object>();
		camposCondicion.put("codigoProyecto", codigoProyecto);		
	 ...
	 * @throws Exception
	 */
	public Integer numeroLineasAccionPartnerSeleccionado(Integer codigoPartner)throws Exception{
		String sql="SELECT COUNT(PGI) FROM ProjectsGenderInfo PGI WHERE PGI.projectsStrategicPartners.pspaId=:codigoPartner AND PGI.pginStatus=TRUE";
		Map<String, Object> camposCondicion=new HashMap<String, Object>();
		camposCondicion.put("codigoPartner", codigoPartner);
		return (Integer) countAll(sql, camposCondicion);
	}
	/**
	 * Busca por el codigo de proyecto y si no tiene plan de género
	 * @param codigoProyecto
	 * @return
	 * @throws DaoException
	 */
	public ProjectsGenderInfo buscaProjectGenderInfoPorPlanGeneroProyecto(int codigoProyecto)throws DaoException{
		try{
		String sql="SELECT PGI from ProjectsGenderInfo PGI WHERE PGI.projects.projId=:codigo AND PGI.pginHasToPlan=FALSE";
		Map<String, Object> camposCondicion=new HashMap<String, Object>();
		camposCondicion.put("codigo", codigoProyecto);		
		return findByCreateQuerySingleResult(sql, camposCondicion);
		}catch(NoResultException e){
			return null;
		}catch(Exception e){
